                ...
                <div className="container max-w-full px-6">
                    <div className="flex flex-wrap justify-between items-start mb-8">
                        <div className="w-full md:w-1/2 lg:w-1/4 p-4">
                            ...
                            <p className="text-gray-700">Công TTHH một thành viên Tuan Anh Junior @tuananh21 quản lý bởi
                                FPT
                                Company.</p>
                        </div>
                    ...
                    <div className="text-center">
                        <p className="text-gray-600 text-sm">
                            Bản quyền © 2024-2035 tuananhhuflit.edu.id.vn. Hệ thống trực tuyến bảo vệ người dùng hàng
                            đầu
                            Việt Nam.
                        </p>
                    </div>

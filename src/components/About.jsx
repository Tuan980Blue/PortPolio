            ...
            <div className='bg-gray-100 py-12'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center'>
                        ...
                        <p className='mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl'>Hi, I'm Tuan Anh Jr</p>
                    ...
                    <div className='mt-10'>
                        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
                            ...
                            <div className='border border-cyan-200 rounded-lg md:p-7 py-7  flex flex-col gap-8 items-center shadow-lg shadow-cyan-300'>
                                <h3 className='text-2xl font-semibold text-cyan-600'>Skills & Expertise</h3>
                                <div className='flex items-center justify-center flex-wrap gap-3'>
                                    <div className='border border-cyan-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-cyan-300'>
                                        <img src={Html} alt="" className='w-10' />
                                        <span className='font-semibold'>HTML</span>
                                    </div>
                                    <div className='border border-cyan-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300'>
                                    ...
                                    <div className='border border-cyan-300 flex items-center  w-max px-2 py-1 rounded-lg shadow-md shadow-cyan-300'>

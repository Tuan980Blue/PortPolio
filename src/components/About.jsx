                                    ...
                                    <div className="flex flex-col items-center justify-center gap-8 ">
                                        ...
                                        <div>
                                            ...
                                            <p className='mt-2 text-lg text-gray-600'>
                                                ...
                                                order management systems, yard management platforms, full-stack
                                                websites,
                                                and even a Shopee clone.
                                                My projects showcase my ability to integrate powerful backend solutions
                                                with
                            ...
                            >
                                ...
                                <div className="flex items-start gap-8 mt-6">
                                    ...
                                    <div className={"flex flex-col"}>
                                        ...
                                        <p className="text-sm md:text-lg text-gray-600">Công nghệ thông tin (2021 -
                                            2025)</p>
